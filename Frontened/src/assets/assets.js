...
export const faqs = [
  {
    ...
    description1:
      "To use our platform, you must be at least 18 years of age. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate and complete.",
    description2:
      "Users are responsible for maintaining the confidentiality of their account credentials. You agree to use the platform solely for the purpose of seeking inclusive employment and agree not to engage in any activity that interferes with or disrupts the services.",
  },
  {
    id: 2,
    title: "Employer Responsibilities for Inclusive Hiring",
    description1:
      "Employers using this platform commit to providing equal employment opportunities and fostering an inclusive workplace. You agree to provide clear information about workplace accessibility and reasonable accommodations available for each role.",
    description2:
      "Employers are prohibited from using the platform for any discriminatory hiring practices. You agree to comply with all applicable labor laws and regulations regarding disability rights and equal opportunity employment.",
  },
  {
    id: 3,
    title: "Accessibility Commitment",
    description1:
      "We are dedicated to ensuring our platform is accessible to everyone. We strive to meet the Web Content Accessibility Guidelines (WCAG) 2.1 Level AA standards to provide a seamless experience for all users.",
    description2:
      "We continuously monitor and improve the accessibility of our site. If you encounter any barriers or have suggestions for improvement, please contact our support team so we can address your needs promptly.",
  },
  {
    id: 4,
    title: "Use of Assistive Features",
    description1:
      "Our portal is designed to be compatible with various assistive technologies, including screen readers, voice recognition software, and keyboard-only navigation. We provide built-in accessibility filters to help you find jobs that match your specific accessibility needs.",
    description2:
      "By using these features, you agree to use them for their intended purpose of enhancing your job search experience. We do not guarantee compatibility with every possible version of third-party assistive software but aim for the broadest support possible.",
  },
  {
    id: 5,
    title: "Privacy and Protection of User Data",
    description1:
      "Your privacy is paramount, especially regarding sensitive disability-related information. We collect and process your data in accordance with our Privacy Policy to facilitate your job search and ensure employer compliance with inclusive practices.",
    description2:
      "Disability-related data you choose to share is protected and only shared with prospective employers with your explicit consent or as part of a voluntary disclosure for accommodation purposes.",
  },
  {
    id: 6,
    title: "Job Posting Guidelines",
    description1:
      "All job postings must be legitimate, inclusive, and explicitly state any physical or cognitive requirements of the role. Postings should highlight the availability of reasonable accommodations and the accessibility of the work environment.",
    description2:
      "Misleading, fraudulent, or discriminatory job postings are strictly prohibited. We reserve the right to remove any posting that does not align with our mission of fostering inclusive employment.",
  },
  {
    id: 7,
    title: "Prohibited Misuse of the Platform",
    description1:
      "You agree not to use the platform to harass, abuse, or harm another person, or to send spam or unsolicited communications. Any attempt to scrape data, circumvent security measures, or use the platform for unauthorized commercial purposes is strictly prohibited.",
    description2:
      "We reserve the right to suspend or terminate accounts that violate these terms or compromise the safety and integrity of our community.",
  },
  {
    id: 8,
    title: "Limitation of Liability",
    description1:
      "While we strive to connect job seekers with inclusive employers, we do not guarantee employment or the accuracy of job postings. The platform is provided 'as is' without warranties of any kind, either express or implied.",
    description2:
      "In no event shall the platform be liable for any indirect, incidental, or consequential damages arising out of your use of the services or the hiring decisions made by third-party employers.",
  },
];
...
export const DisabilitySupportOptions = [
  "Visual Impairment",
  "Hearing Impairment",
  "Mobility Disability",
